...
if __name__ == "__main__":
    ...
    # todo encapsulate every reconstruction in a function
    ...
    res_apgd = dict(zip(metrics, [dt_apgd, mse_apgd, mad_apgd, apgd.objective_func(), dcv_apgd]))
    ...
    res_monofw = dict(zip(metrics, [dt_monofw, mse_monofw, mad_monofw, monofw.objective_func(), dcv_monofw]))
